...
5] Write a program to insert Number of Nodes in the Binary Tree and Traverse in Inorder , Preorder and Post Order and Search an element in Binary Tree(Display NULL if not found, If found Display Found) 6] Implement Binary search tree(BST) with following Menu operations.
